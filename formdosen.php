    ...
    <div class="card-body">
       <form action="simpandb.php" method="post">
           <div class="form-group">
                <label for="text">Masukkan NIP : </label>
                <input type="text" name = "nrp" placeholder = "Masukkan NIP" class="form-control" required>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
                ...
                <input type="text" name = "bidang"  placeholder = "Bidang Mengajar" class="form-control" required>
           </div>
           <div class="form-group">
            ...
            <br><button type="submit" class="btn btn-success" name="simpan1">Simpan</button>
       </form>
    </div>
    </div>
</div>
