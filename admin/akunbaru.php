...
<div class="sidenav">
  ...
  <a href="./akunbaru.php">Buat Akun</a>
...
<div class="container">
    ...
    <div class="card-body">
       ...
       <div class="form-group">
                ...
                <input type="radio" name = "level" required value=admin > Admin <input type="radio" name = "level" required value=mahasiswa > Mahasiswa <input type="radio" name = "level" required value=dosen > Dosen
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
                ...
                <input type="text" name = "username" placeholder = "Buat Username" class="form-control" required>
           </div>
           <div class="form-group">
                <label for="text">Password : </label>
                <input type="password" name = "pw"  placeholder = "Buat Password" class="form-control" required>
           </div><br>
